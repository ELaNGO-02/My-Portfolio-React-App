                ...
                >
                  <motion.div
                    initial={{
                      opacity: 0,
                      y: 50,
                      x: windowWidth >= 768 ? (isLeft ? -100 : 100) : 0,
                    ...
                    className="w-full md:w-[45%] bg-[#0b0e1a]/90 border border-[#1b1d2f] rounded-2xl p-6 md:p-8 backdrop-blur-md shadow-[0_0_20px_rgba(0,224,255,0.15)] hover:shadow-[0_0_40px_rgba(0,224,255,0.3)] transition"
                  >
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      {exp.technologies.map((tech, i) => (
                        <span
                          key={i}
                          className="bg-[#141527]/90 border border-[#1b1c28] text-gray-300 text-xs md:text-sm px-2 py-1 rounded-full hover:bg-[#00e0ff]/10 transition"
                        >
                          {tech}
                        </span>
                      ))}
